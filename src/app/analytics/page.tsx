...
import Hazardous from '../../components/icon/Hazardous';
import Moderate from '../../components/icon/Moderate';
import Unhealthy from '../../components/icon/Unhealthy';
import UnhealthySG from '../../components/icon/UnhealthySG';
import VeryUnhealthy from '../../components/icon/VeryUnhealthy';
